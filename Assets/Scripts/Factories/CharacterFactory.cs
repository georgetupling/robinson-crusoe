...
public static class CharacterFactory
{
    ...
    static Ability carpenterAbility1 = new Ability("Craftsmanship", 2, 0, false, null);
    ...
    static Ability cookAbility1 = new Ability("Scrounger", 2, 0, false, null);
    ...
    static Ability explorerAbility0 = new Ability("Lucky", 2, 0, false, null);
    ...
    static Ability soldierAbility2 = new Ability("Frenzy", 3, 0, false, null);
