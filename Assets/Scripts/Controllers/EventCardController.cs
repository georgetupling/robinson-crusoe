...
public class EventCardController : CardController
{
    ...
    protected override void Start() {
        ...
        EventGenerator.Singleton.AddListenerToEventCardPopupClosedEvent(OnEventCardPopupClosedEvent);
    }
    ...
    void OnEventCardPopupClosedEvent(int componentIdOfCardController) {
